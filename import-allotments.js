...
async function main() {
  ...
  if (!isDryRun && !isApply && !isReconcile) {
    console.log("Usage:");
    console.log("  Dry Run:       node import-allotments.js --dry-run");
    console.log("  Apply Import:  node import-allotments.js --apply");
    console.log("  Fix Existing:  node import-allotments.js --apply --fix-existing");
    console.log("  Reconcile:     node import-allotments.js --reconcile");
    process.exit(1);
  }
